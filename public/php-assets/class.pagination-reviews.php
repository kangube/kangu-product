...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
	...
	$rating_results = $mysqli->query("SELECT AVG(review_rating) AS average_rating FROM tbl_review WHERE fk_advert_id='".$_POST['id']."'");
	...
	echo "<div class='small-12 columns advert-detail-counter-container'>
			<p class='advert-detail-counter-rating'>".$average_rating."</p>
		  	<p class='advert-detail-counter-reviews' data-icon='o'>".$get_total_rows[0]." geschreven reviews</p>
		  </div>";
